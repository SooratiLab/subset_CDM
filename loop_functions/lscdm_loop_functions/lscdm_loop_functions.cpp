#include "lscdm_loop_functions.h"
#include <argos3/core/simulator/simulator.h>
#include <argos3/core/utility/configuration/argos_configuration.h>
#include <argos3/plugins/robots/foot-bot/simulator/footbot_entity.h>
#include <controllers/leader_subset/leader_subset.h>
...
void CCDMLoopFunctions::PreStep() {
   ...
   for (CSpace::TMapPerType::iterator it = m_cFootbots.begin(); it != m_cFootbots.end(); ++it) {
      ...
      /* Initialize opinions and assign a leader at the first step */
      if (GetSpace().GetSimulationClock() == 1) {
         if (nr % 2 == 0) { cController.SetOpinionWhite(); }
         nr++;
         if (NoLeader) { cController.SetLeader(); NoLeader = false; }
      }
...
/****************************************/
REGISTER_LOOP_FUNCTIONS(CCDMLoopFunctions, "lscdm_loop_functions")
