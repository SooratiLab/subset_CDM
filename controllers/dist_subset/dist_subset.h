#ifndef DIST_SUBSET_H
#define DIST_SUBSET_H
...
public:
   ...
   inline Real GetConvergenceCertainty() const {
      return m_sStateData.ConvergenceCertainty;
   }
